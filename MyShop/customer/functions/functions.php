                ...
                if (!isset($_GET['delete_account'])) {
                    ...
                    if ($count_orders > 0) {
                        ...
                        <div style='padding:10px'>
                            ...
                            <h3>Please check your order details by clicking this <a href='my_account.php?my_orders'>LINK</a><br>Or else you can <a href='pay_offline.php'>Pay Offline Here </a></h3>
                        </div>
                        ";
                    }
                    else{
                        ...
                        <div style='padding:10px'>
                           ...
                           <h3>You can check your orders history by clicling <a href='my_account.php?my_orders'>LINK</a></h3>
                        ";
